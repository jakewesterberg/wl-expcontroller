...
- **Where it stands:** Tasks 1–10 are done on branch `p4d2a-return-to-cage`, rebased onto `main` at `f195d6a` and pushed. That is 739 tests; not on main until it merges.
- **What Task 10 found:**
